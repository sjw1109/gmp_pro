/*
 *   xpcbytepacking64.c - Inlined S-function for xPC byte packing & unpacking.
 *
...
//
// #include "resources/slrealtime/license.hpp" /* header file for xml message catalog */
// #include "services/lmgr/lmgrcore.hpp"       /* header file for license */
// #include "sl_services/slsv_diagnostic_serialization.hpp"
...
*--------------------|----------|----------|----------|----------*
* Data Type          |   Mask   |   Mask   | Inherit  |   Mask   *
*--------------------|----------|----------|----------|----------*
* Width & Dimensions | Inherit  | Compute  | Inherit  |   Mask   *
*                    |          |    or    |          |          *
*                    |          | Inherit  |          |          *
\****************************************************************/
...
% source: MaskAlignment
[NumberUnpackedPorts1, UnpackedDataTypes1, UnpackedDataSizes1, ...
     NumberPackedPorts1, PackedDataTypes1, PackedDataSizes1, ...
     Alignment1] = mdl_gmp_simulink_core( ...
...
enum
{
    ...
    S_ALIGNMENT, // Byte alignment
                 //    S_DIRECTION,                 // Is this a byte packing or unpacking block
                 //    S_DEBUG,                     // Debug level

    //S_NETWORK,   // NETWORK param
    NUM_S_PARAMS // Number of parameters passed from the mask
};

#define BYTE_PACKING   0
#define BYTE_UNPACKING 1
#define SKIP           -1

// static std::string Direction[] = {"Pack", "Unpack"};

#define DEBUG_ENTRY   0x1
#define DEBUG_PARAMS  0x2
#define DEBUG_MAPPING 0x4
