...
// GMP Standard cross platform header

#ifndef _FILE_CROSS_PATFORM_H_
#define _FILE_CROSS_PATFORM_H_
...
#include <ctl_main.h>
    ...
    //////////////////////////////////////////////////////////////////////////
    // ADC result will copy to this array
    ...
    // This function may called by ctl_base_
    GMP_STATIC_INLINE
    void ctl_input_callback(void)
    {
        // rearrange iabc, uabc data
        ...
        ctl_step_autoturn_pos_encoder(&pos_enc, 0x3FFF - (gmp_l2b16(enc_res) & 0x3FFF));
    }
