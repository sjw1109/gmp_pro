...
void ctl_output_callback(void)
{
    ...
    simulink_tx_buffer.monitor_port[7] = pmsm_mtpa_ctrl.mtr_interface.position->elec_position;
...
void ctl_fmif_output_stage_routine(ctl_object_nano_t *pctl_obj)
{
    ...
    // simulink_tx_buffer.monitor_port[0] = pmsm_mtpa_ctrl.idq0.dat[phase_d];
    simulink_tx_buffer.monitor_port[0] = pmsm_mtpa_ctrl.idq_set.dat[phase_q];
    simulink_tx_buffer.monitor_port[1] = pmsm_mtpa_ctrl.idq0.dat[phase_q];

    simulink_tx_buffer.monitor_port[2] = pmsm_mtpa_ctrl.vdq_set.dat[phase_d];
    // simulink_tx_buffer.monitor_port[3] = pmsm_mtpa_ctrl.vdq_set.dat[phase_q];

    // simulink_tx_buffer.monitor_port[3] = pmsm_mtpa_ctrl.mtr_interface.position->elec_position;
    simulink_tx_buffer.monitor_port[3] = pmsm_mtpa_ctrl.mtr_interface.velocity->speed;
}
