...
void ctl_output_callback(void)
{
    ...
    simulink_tx_buffer.monitor_port[5] = pmsm_ctrl.mtr_interface.velocity->speed * MOTOR_PARAM_MAX_SPEED / 9.55;
    
    simulink_tx_buffer.monitor_port[6] = pmsm_ctrl.smo.spdif.speed * MOTOR_PARAM_MAX_SPEED / 9.55;
