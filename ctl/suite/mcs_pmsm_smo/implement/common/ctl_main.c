...
void ctl_init()
{
    ...
    pmsm_ctrl_init.current_pid_gain = (parameter_gt)(MOTOR_PARAM_LS * MTR_CTRL_CURRENT_LOOP_BW * 2 * PI *
                                                     MTR_CTRL_VOLTAGE_BASE / MTR_CTRL_CURRENT_BASE); // 100 Hz, discrete
    ...
    pmsm_ctrl_init.spd_pid_gain = (parameter_gt)(4.5);
    ...
    pmsm_ctrl_init.u_base = (parameter_gt)(MOTOR_PARAM_MAX_DC_VOLTAGE);
    pmsm_ctrl_init.i_base = (parameter_gt)(MOTOR_PARAM_MAX_PH_CURRENT);

    // SMO controller parameters
    pmsm_ctrl_init.speed_base_rpm = (parameter_gt)(MOTOR_PARAM_MAX_SPEED);
    pmsm_ctrl_init.smo_fc_e = 20.0f;
    pmsm_ctrl_init.smo_fc_omega = 50.0f;
