...
void ctl_init_adc_dual_channel(adc_dual_channel_t *adc, ctrl_gt gain, ctrl_gt bias, fast_gt resolution, fast_gt iqn)
{
    int i = 0;
...
void ctl_init_adc_tri_channel(adc_tri_channel_t *adc, ctrl_gt gain, ctrl_gt bias, fast_gt resolution, fast_gt iqn)
{
    int i = 0;
