...
#define MOTOR_PMSM_NAMEPLATE_CONSULTANT_WRAPPER                                                                        \
    {                                                                                                                  \
        MOTOR_RATED_POLE_PAIRS, MOTOR_RATED_OUTPUT_POWER, MOTOR_RATED_VOLTAGE, MOTOR_RATED_CURRENT,                    \
            MOTOR_RATED_POWER_FACTOR, MOTOR_RATED_FREQUENCY, MOTOR_RATED_SPEED_RPM, MOTOR_RATED_TORQUE,                \
...
#define MOTOR_PMSM_DESIGN_CONSULTANT_WRAPPER                                                                           \
    {                                                                                                                  \
        MOTOR_DSN_POLE_PAIR, MOTOR_DSN_STATOR_RES, MOTOR_DSN_LD, MOTOR_DSN_LQ, MOTOR_DSN_FLUX_WB, MOTOR_DSN_INERTIA,   \
            MOTOR_DSN_DAMP                                                                                             \
    }
