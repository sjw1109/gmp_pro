...
//}
//
//size_gt gmp_gpio_stm32_impl_t::write( data_type data)
//{
...
//size_gt gmp_uart_stm32_impl_t::read(data_gt* data, size_gt length) 
//{
...
//}
//
//size_gt gmp_uart_stm32_impl_t::write(data_type* data, size_gt length) 
//{
...
//}
//
//size_gt gmp_uart_stm32_impl_t::write(const data_gt* data, size_gt length)
//{
...
//}
//
//data_gt gmp_uart_stm32_impl_t::read()
//{
//	data_gt content;
//
...
//}
//
//size_gt gmp_uart_stm32_impl_t::write( data_gt data)
//{
...
//size_gt gmp_iic_stm32_impl_t::read(addr_type device_addr, data_type* data, size_gt length) 
//{
...
//}
//
//size_gt gmp_iic_stm32_impl_t::write(addr_type device_addr, data_type* data, size_gt length)
//{
...
//}
//
//size_gt gmp_iic_stm32_impl_t::read(addr_type device_addr, addr_type reg_addr, data_type* data, size_gt length)
//{
...
//}
//
//size_gt gmp_iic_stm32_impl_t::write(addr_type device_addr, addr_type reg_addr, data_type* data, size_gt length)
//{
...
//}
//
//size_gt gmp_spi_stm32_impl_t::write(data_type data) 
//{
...
//}
//
//size_gt gmp_spi_stm32_impl_t::read(data_type* data, size_gt length)
//{
...
//}
//
//size_gt gmp_spi_stm32_impl_t::write(data_type* data, size_gt length) 
//{
//	// 		HAL_GPIO_WritePin(GPIOD, GPIO_PIN_0, GPIO_PIN_SET);
//
...
//}
//
//size_gt gmp_spi_stm32_impl_t::readwrite(data_type* data_in,  data_type* data_out, size_gt length)
//{
